                                ...
                                <ClickAwayListener mouseEvent="onMouseDown" touchEvent="onTouchStart" onClickAway={this.handleTooltipClose.bind(this)}>
                                    <div>
                                        <HtmlTooltip
                                            ...
                                            title={
                                            <React.Fragment>
                                                <Typography style={{ textAlign: 'center', fontFamily: 'Roboto', fontSize: 20, fontWeight: 700, lineHeight: '94%', paddingTop: 10, paddingBottom: 20 }}>Пищевая ценность на 100 г</Typography>
                                                        ...
                                                        <div style={{ border: '2px solid #fff', borderRadius: 10, marginBottom: this.state.item.items.length == 1 ? 0 : this.state.item.items.length-1 == key ? 0 : 20 }} key={key}>
                                                            <div style={{ width: '100%', display: 'flex', flexDirection: 'row', borderBottom: '2px solid #fff' }}>
                                                                <div style={{ width: '75%', display: 'flex', alignItems: 'center', borderRight: '2px solid #fff', padding: 10 }}>
                                                                    <Typography style={{ fontFamily: 'Roboto', fontWeight: 700, fontSize: 17, lineHeight: '90%' }}>{item.name}</Typography>
                                                                </div>
                                                                <div style={{ width: '25%', display: 'flex', alignItems: 'center', flexDirection: 'column', justifyContent: 'center', padding: 10 }}>
                                                                    <Typography style={{ fontSize: 26, lineHeight: '100%', fontFamily: 'Roboto', fontWeight: 700 }}>{item.kkal}</Typography>
                                                                    <Typography style={{ fontSize: 14, lineHeight: '98%', fontFamily: 'Roboto', fontWeight: 400 }}>ккал</Typography>
                                                                </div>
                                                            </div>
                                                            <div style={{ width: '100%', display: 'flex', flexDirection: 'row' }}>
                                                                <div style={{ width: '50%', paddingTop: 10, paddingLeft: 10, paddingRight: 10, borderRight: '2px solid #fff' }}>
                                                                    <Typography style={{ fontSize: 11, fontFamily: 'Roboto', fontWeight: 400, lineHeight: '100%' }}>Состав: {item.tmp_desc}</Typography>
                                                                </div>
                                                                <div style={{ width: '50%', paddingTop: 10, paddingLeft: 10, paddingRight: 10 }} className='styleTooltip'>
                                                                    <div style={{ display: 'flex', flexDirection: 'row', justifyContent: 'space-between' }}>
                                                                        <Typography style={{ fontSize: 14, lineHeight: '98%', fontFamily: 'Roboto', fontWeight: 400, order: 1 }}>белки</Typography>
                                                                        <Typography style={{ fontSize: 14, lineHeight: '98%', fontFamily: 'Roboto', fontWeight: 400, order: 3 }}>{item.protein} г</Typography>
                                                                    </div>
                                                                    <div style={{ display: 'flex', flexDirection: 'row', justifyContent: 'space-between' }}>
                                                                        <Typography style={{ fontSize: 14, lineHeight: '98%', fontFamily: 'Roboto', fontWeight: 400, order: 1 }}>жиры</Typography>
                                                                        <Typography style={{ fontSize: 14, lineHeight: '98%', fontFamily: 'Roboto', fontWeight: 400, order: 3 }}>{item.fat} г</Typography>
                                                                    </div>
                                                                    <div style={{ display: 'flex', flexDirection: 'row', justifyContent: 'space-between' }}>
                                                                        <Typography style={{ fontSize: 14, lineHeight: '98%', fontFamily: 'Roboto', fontWeight: 400, order: 1 }}>углеводы</Typography>
                                                                        <Typography style={{ fontSize: 14, lineHeight: '98%', fontFamily: 'Roboto', fontWeight: 400, order: 3 }}>{item.carbohydrates} г</Typography>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
