            ...
            <>
                            ...
                            { this.state.count == 0 ?
                                <ButtonGroup disableElevation={true} disableRipple={true} variant="contained">
                                    <Button variant="contained" className='ModalItemButtonCart' style={{ width: 300, height: 60, borderRadius: 40, border: '2px solid #F9BC23', backgroundColor: '#fff' }} onClick={this.add.bind(this)}>
                                        <span style={{ fontSize: '1.5rem', textTransform: 'initial', fontFamily: 'Roboto', color: '#525252', fontWeight: 700 }}>В корзину за { new Intl.NumberFormat('ru-RU').format(this.state.item.price)}</span>
                                ...
                                <ButtonGroup disableElevation={true} disableRipple={true} variant="contained">
                                    <div variant="contained" className='ModalItemButtonCart' style={{ width: 300, height: 56, borderRadius: 40, border: '2px solid #F9BC23', backgroundColor: '#fff', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                                        ...
                                        <div>
                                            <span style={{ fontSize: '1.5rem', textTransform: 'initial', fontFamily: 'Roboto', color: '#525252', fontWeight: 700 }}>{this.state.count} {item_name} на { new Intl.NumberFormat('ru-RU').format( parseInt(this.state.item.price) * parseInt(this.state.count) )}</span>
                                            <IconRuble style={{ width: 15, height: 15, fill: '#525252', marginLeft: 5 }} />
                                        </div>
                ...
                <Hidden smUp>
                    <Grid container className="MainItem mainContainer" style={{ height: '100%', paddingRight: 20, paddingLeft: 20 }}>
                        ...
                        <Grid item xs={12}>
                            <Typography component="span" style={{ textAlign: 'center', fontFamily: 'Roboto', fontSize: '1rem', fontWeight: 400, color: '#525252' }}>{desc}</Typography>
                        </Grid>
