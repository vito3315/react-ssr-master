            ...
            <>
                ...
                <Box component="div" className="pcItem NewModal" >
                    <Grid container className="MainItem mainContainer" style={{ height: '86vh' }}>
                        ...
                        <Grid item style={{ width: '29%', marginTop: '6%', marginBottom: '6%', justifyContent: 'start', position: 'relative' }}>
                                ...
                                <ClickAwayListener mouseEvent="onMouseDown" touchEvent="onTouchStart" onClickAway={this.handleTooltipClose.bind(this)}>
                                    <div>
                                        <HtmlTooltip
                                            ...
                                            title={
                                            <React.Fragment>
                                                <Typography style={{ textAlign: 'center', fontFamily: 'Roboto', fontSize: '20pt', fontWeight: 400, lineHeight: 'normal', paddingTop: 10, paddingBottom: 20 }}>Пищевая ценность на 100 г</Typography>
                                                
                                                <div style={ this.state.item.items.length > 1 ? { overflowY: 'scroll', maxHeight: 350 } : {}}>
                                                    { this.state.item.items.map( (item, key) =>
                                                        <div style={{ border: '2px solid #fff', borderRadius: 10, height: 160, marginBottom: this.state.item.items.length == 1 ? 0 : this.state.item.items.length-1 == key ? 0 : 20 }} key={key}>
                                                            <div style={{ width: '100%', display: 'flex', height: 60, flexDirection: 'row', borderBottom: '2px solid #fff' }}>
                                                                <div style={{ width: '75%', display: 'flex', alignItems: 'center', borderRight: '2px solid #fff', padding: 10 }}>
                                                                    <Typography style={{ fontFamily: 'Roboto', fontWeight: 300, fontSize: '15pt', lineHeight: 'normal' }}>{item.name}</Typography>
                                                                </div>
                                                                <div style={{ width: '25%', display: 'flex', alignItems: 'center', flexDirection: 'column', justifyContent: 'center', padding: 10 }}>
                                                                    <Typography style={{ fontSize: '25pt', lineHeight: 'normal', fontFamily: 'Roboto', fontWeight: 500 }}>{item.kkal}</Typography>
                                                                    <Typography style={{ fontSize: '11pt', lineHeight: 'normal', fontFamily: 'Roboto', fontWeight: 300 }}>ккал</Typography>
                                                                </div>
                                                            </div>
                                                            <div style={{ width: '100%', height: 98, display: 'flex', flexDirection: 'row' }}>
                                                                <div style={{ width: '50%', paddingTop: 10, paddingLeft: 10, paddingRight: 10, borderRight: '2px solid #fff' }}>
                                                                    <Typography style={{ fontSize: '11pt', fontFamily: 'Roboto', fontWeight: 300, lineHeight: 'normal' }}>Состав: {item.tmp_desc}</Typography>
                                                                </div>
                                                                <div style={{ width: '50%', paddingTop: 10, paddingLeft: 10, paddingRight: 10 }} className='styleTooltip'>
                                                                    <div style={{ display: 'flex', flexDirection: 'row', justifyContent: 'space-between' }}>
                                                                        <Typography style={{ fontSize: '11pt', lineHeight: 'normal', fontFamily: 'Roboto', fontWeight: 300, order: 1 }}>белки</Typography>
                                                                        <Typography style={{ fontSize: '11pt', lineHeight: 'normal', fontFamily: 'Roboto', fontWeight: 300, order: 3 }}>{item.protein} г</Typography>
                                                                    </div>
                                                                    <div style={{ display: 'flex', flexDirection: 'row', justifyContent: 'space-between' }}>
                                                                        <Typography style={{ fontSize: '11pt', lineHeight: 'normal', fontFamily: 'Roboto', fontWeight: 300, order: 1 }}>жиры</Typography>
                                                                        <Typography style={{ fontSize: '11pt', lineHeight: 'normal', fontFamily: 'Roboto', fontWeight: 300, order: 3 }}>{item.fat} г</Typography>
                                                                    </div>
                                                                    <div style={{ display: 'flex', flexDirection: 'row', justifyContent: 'space-between' }}>
                                                                        <Typography style={{ fontSize: '11pt', lineHeight: 'normal', fontFamily: 'Roboto', fontWeight: 300, order: 1 }}>углеводы</Typography>
                                                                        <Typography style={{ fontSize: '11pt', lineHeight: 'normal', fontFamily: 'Roboto', fontWeight: 300, order: 3 }}>{item.carbohydrates} г</Typography>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
