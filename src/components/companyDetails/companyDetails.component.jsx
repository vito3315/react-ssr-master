...
export class PageCompanyDetails extends React.Component {
    _isMounted = false;
    ...
    componentDidMount(){
        ...
        window.scrollTo(0, 0);
        itemsStore.setPage('PageCompanyDetails');
        
        PageCompanyDetails.fetchData('/'+this.state.city_name).then( data => {
    ...
    render() {
        return (
            <>
                ...
                <Grid container className="PAGEdetails mainContainer">
