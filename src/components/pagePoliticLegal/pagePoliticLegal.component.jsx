...
export class PagePoliticLegal extends React.Component {
    _isMounted = false;
    ...
    componentDidMount(){
        ...
        window.scrollTo(0, 0);
        itemsStore.setPage('PagePoliticLegal');
        
        PagePoliticLegal.fetchData('/'+this.state.city_name).then( data => {
    ...
    render() {
        return (
            <>
                ...
                <Grid container className="PAGELegal mainContainer">
