                        ...
                        <LazyLoad once height={150}>
                            {img_type == 'old' ?
                                ...
                                <picture>
                                    ...
                                    <img alt={this.state.item.name} title={this.state.item.name} style={{ maxHeight: 250, objectFit: 'none' }} src={`https://storage.yandexcloud.net/site-img/${img_name}_138x138.jpg`} />
                                </picture>
                            }
                        </LazyLoad>
