                        ...
                        {img_type == 'old' ?
                            ...
                            <picture>
                                <source 
                                    type="image/webp" 
                                    srcset={`
                                        https://cdnimg.jacofood.ru/${img_name}_276x276.webp 138w,
                                        https://cdnimg.jacofood.ru/${img_name}_292x292.webp 146w,
                                        https://cdnimg.jacofood.ru/${img_name}_366x366.webp 183w,
                                        https://cdnimg.jacofood.ru/${img_name}_466x466.webp 233w,
                                        https://cdnimg.jacofood.ru/${img_name}_585x585.webp 292w,
                                        https://cdnimg.jacofood.ru/${img_name}_732x732.webp 366w,
                                        https://cdnimg.jacofood.ru/${img_name}_1168x1168.webp 584w,
                                        https://cdnimg.jacofood.ru/${img_name}_1420x1420.webp 760w,
                                        https://cdnimg.jacofood.ru/${img_name}_2000x2000.webp 1875w`} 
                                    sizes="(max-width=1439px) 233px, (max-width=1279px) 218px, 292px" />
                                <source 
                                    type="image/jpeg" 
                                    srcset={`
                                        https://cdnimg.jacofood.ru/${img_name}_276x276.jpg 138w,
                                        https://cdnimg.jacofood.ru/${img_name}_292x292.jpg 146w,
                                        https://cdnimg.jacofood.ru/${img_name}_366x366.jpg 183w,
                                        https://cdnimg.jacofood.ru/${img_name}_466x466.jpg 233w,
                                        https://cdnimg.jacofood.ru/${img_name}_585x585.jpg 292w,
                                        https://cdnimg.jacofood.ru/${img_name}_732x732.jpg 366w,
                                        https://cdnimg.jacofood.ru/${img_name}_1168x1168.jpg 584w,
                                        https://cdnimg.jacofood.ru/${img_name}_1420x1420.jpg 760w,
                        ...
                        {img_type == 'old' ?
                            ...
                            <picture>
                                <source 
                                    type="image/webp" 
                                    srcset={`
                                        https://cdnimg.jacofood.ru/${img_name}_138x138.webp 138w,
                                        https://cdnimg.jacofood.ru/${img_name}_146x146.webp 146w,
                                        https://cdnimg.jacofood.ru/${img_name}_183x183.webp 183w,
                                        https://cdnimg.jacofood.ru/${img_name}_233x233.webp 233w,
                                        https://cdnimg.jacofood.ru/${img_name}_292x292.webp 292w,
                                        https://cdnimg.jacofood.ru/${img_name}_366x366.webp 366w,
                                        https://cdnimg.jacofood.ru/${img_name}_584x584.webp 584w,
                                        https://cdnimg.jacofood.ru/${img_name}_760x760.webp 760w,
                                        https://cdnimg.jacofood.ru/${img_name}_1875x1875.webp 1875w`} 
                                    sizes="(max-width=1439px) 233px, (max-width=1279px) 218px, 292px" />
                                <source 
                                    type="image/jpeg" 
                                    srcset={`
                                        https://cdnimg.jacofood.ru/${img_name}_138x138.jpg 138w,
                                        https://cdnimg.jacofood.ru/${img_name}_146x146.jpg 146w,
                                        https://cdnimg.jacofood.ru/${img_name}_183x183.jpg 183w,
                                        https://cdnimg.jacofood.ru/${img_name}_233x233.jpg 233w,
                                        https://cdnimg.jacofood.ru/${img_name}_292x292.jpg 292w,
                                        https://cdnimg.jacofood.ru/${img_name}_366x366.jpg 366w,
                                        https://cdnimg.jacofood.ru/${img_name}_584x584.jpg 584w,
                                        https://cdnimg.jacofood.ru/${img_name}_760x760.jpg 760w,
                                        https://cdnimg.jacofood.ru/${img_name}_1875x1875.jpg 1875w`} 
                                    sizes="(max-width=1439px) 233px, (max-width=1279px) 218px, 292px" />
                                <img 
                                    alt={this.state.item.name} 
                                    title={this.state.item.name} 
                                    src={`https://cdnimg.jacofood.ru/${img_name}_366x366.jpg`} 
                ...
                <Card elevation={0} className="CardItem" style={{ width: '100%' }}>
                    ...
                    <CardContent style={{ cursor: 'pointer', height: '100%', display: 'flex', flexDirection: 'column', justifyContent: 'space-between', position: 'relative' }} onClick={ () => this.props.openItem(this.state.item.id)}>
                        ...
                        {img_type == 'old' ?
                            <picture>
                                <source 
                                    srcSet={"https://cdnimg.jacofood.ru/"+this.state.item.img_new+"300х200.webp?"+this.state.item.img_new_update} 
                                    type="image/webp" 
                                />
                                <img 
                                    datasrc={"https://cdnimg.jacofood.ru/"+this.state.item.img_new+"300х200.jpg?"+this.state.item.img_new_update} 
                                    alt={this.state.item.name}
                                    title={this.state.item.name}
                                    style={{ minHeight: 150 }}
                                    loading="lazy"
                            ...
                            <picture>
                                ...
                                <img 
                                    ...
                                    title={this.state.item.name}
                                    loading="lazy"
                                    datasrc={`https://cdnimg.jacofood.ru/${img_name}138x138.jpg`} />
                            </picture>
                        }
                                                    ...
                                                    { item.img_app.length == 0 || !item.img_app ?
                                                        ...
                                                        <picture>
                                                            ...
                                                            <img 
                                                                ...
                                                                title={item.name} 
                                                                style={{ width: '100%', height: 'auto' }} 
                                                                src={`https://cdnimg.jacofood.ru/${item.img_app}138x138.jpg`} />
                                                        </picture>   
                                                    }
                                                </div>
                                                ...
                                                { item.img_app.length == 0 || !item.img_app ?
                                                    ...
                                                    <picture>
                                                        ...
                                                        <img 
                                                            ...
                                                            title={item.name} 
                                                            style={{ width: '100%', height: 'auto' }} 
                                                            src={`https://cdnimg.jacofood.ru/${item.img_app}_138x138.jpg`} />
                                                    </picture>
                                                }
                                            </div>
