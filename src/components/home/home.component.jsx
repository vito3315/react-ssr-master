            ...
            this.state.is_load === false ?
                ...
                <Element name="myScrollToElement" className="Category">
                    ...
                    {this.state.openItem ?
                        <>
                            <Hidden smUp>
                                <Dialog fullScreen style={{ borderRadius: 50 }} onClose={this.handleClosePCSet.bind(this)} className="modalActii Item OpenItemPCSet" open={this.state.openModalPCSet} TransitionComponent={Transition}>
                                    <MuiDialogTitle disableTypography style={{ margin: 0, padding: 0 }}>
